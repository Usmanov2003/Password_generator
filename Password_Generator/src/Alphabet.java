public class Alphabet {
    ...
    public Alphabet(boolean uppercaseIcluded, boolean lowercaseIncluded, boolean numbersIncluded, boolean specialCharactersIncluded) {
        pool = new StringBuilder();

        if (uppercaseIcluded) pool.append(UPPERCASE_LETTERS);
