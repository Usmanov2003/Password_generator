...
public class GeneratorTest {
    ...
    private final Alphabet firstAlphatbet = new Alphabet(true, false,false,false);
    ...
    @Test
    void test1() { assertEquals("Secret",password.toString());}

    @Test
    void test2() { assertEquals(firstAlphatbet.getAlphabet(), Alphabet.UPPERCASE_LETTERS);}
    ...
    @Test
    void test5() {assertEquals(generator.alphabet.getAlphabet().length(), 26);}
}
